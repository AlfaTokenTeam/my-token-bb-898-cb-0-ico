...
import "./MyTokenBB898CB0.sol";

contract MyTokenBB898CB0PreSale {
    MyTokenBB898CB0 public token;
    ...
    function MyTokenBB898CB0PreSale(
        MyTokenBB898CB0 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenBB898CB0(_token);
